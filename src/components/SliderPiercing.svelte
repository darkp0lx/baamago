<script>
  ...
  const carouselPhotos = [
    ...
    "https://firebasestorage.googleapis.com/v0/b/crud-d8ca2.appspot.com/o/seo-image%2Fpiercing1.jpg?alt=media&token=eabf4743-c104-4d20-89c3-f9744aae6d23",
...
<div class="SliderPiercing">
  <div class="container-sliderPiercing">
    <h2>Piercing</h2>
    {#each [carouselPhotos[index]] as src (index)}
      <div class="container-img">
        <img transition:fade {src} alt="wallpaper.png" />
      </div>
    {/each}
  </div>
</div>
